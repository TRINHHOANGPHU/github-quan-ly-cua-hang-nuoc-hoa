...
public class PhieuNhap_VIEW {
		...
		private JTextField TongTien_text;
		...
		public PhieuNhap_VIEW() {
			...
			TongTien_text = new JTextField();
			TongTien_text.setPreferredSize(new Dimension(200, 65));
			TongTien_text.setFont(fontChuDe.FONT_MENU_LEFT.getFont());
			TongTien_text
					.setBorder(new TitledBorder(matte, "Tổng tiền", 0, 0, fontChuDe.FONT_TITLE_BORDER.getFont(), null));
			...
			jPanel_Input.add(TongTien_text);
